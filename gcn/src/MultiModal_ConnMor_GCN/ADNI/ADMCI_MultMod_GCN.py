...
# clfo = LocalOutlierFactor(n_neighbors=2)
# clfo.fit_predict(X_admci)

# outlier = clfo.negative_outlier_factor_
# print(outlier)
# exc = []
# for i, a in enumerate(outlier):
#   if a < -1.41:
#     exc.append(i)
# print(exc)
...
# X_admci = X_admci[mask]
# y_admci = y_admci[mask]

X_admci = X_admci[-100:]
y_admci = y_admci[-100:]

X_admci, y_admci = shuffle(X_admci, y_admci)
...
ax2.plot(range(args.n_epochs),total_train_accuracies,linewidth=2,color='lime',label = "Train")
ax2.plot(range(args.n_epochs),total_val_accuracies,linewidth=2,color='green',label = "Validation")
